<?php 
	$idProfessor = (isset($_GET['u']))?base64_decode($_GET['u']):$_SESSION['user']['id_pessoa'];
	$professor = IQ_Usuario::getUserInfo($idProfessor); 
?>
<div class="header">
	<p class="spacer"></p>
	<h1>Dados Pessoais</h1>
</div>
<p class="relDescription">Aqui você vê dados pessoais de um professor.</p>
