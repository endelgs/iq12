...
<p class="descricao">Todos os relatórios não entregues por seus orientandos</p>
<p class="margin-15"></p>
<?php if (empty($relatorios)){
	...
	<h3>
		...
		prazo de entrega dia <span class="red" ><?php echo $relatorio['aluno_data_previsto'];?></span> [<a href="<?php echo Config::HOMEURL."?q=".Config::UMRELATORIO."&amp;r=".base64_encode($relatorio['id_relatorio'])?>" title="Ver relatório completo">veja mais</a>]
	</h3>
	<p class="margin-12"></p>
	<?php endforeach;
}?>
...
<p class="tip">Relatórios de orientandos já entregues, nos quais você ainda não deu seu parecer</p>
<p class="margin-15"></p>
...
<h2>Relatórios como Acessorista</h2>
<p class="margin-15"></p>
<h2 class="blue small">Relatórios Pendentes</h2>
<p class="margin-15"></p>
...
if (!empty($relatorios)){
	...
	<h3>
		...
		<span class="red" ><?php echo $relatorio['aluno_data_previsto'];?></span> [<a href="<?php echo Config::HOMEURL."?q=".Config::UMRELATORIO."&amp;r=".base64_encode($relatorio['id_relatorio'])?>" title="Ver relatório completo">veja mais</a>]
	</h3>
	<p class="margin-12"></p>
	<?php endforeach;
}else{?>
