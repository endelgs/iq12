...
<h1 class="header">Disciplinas Ministradas</h1>
<p class="margin-15"></p>
<p>Este relatório mostra as disciplinas que você lecionará durante o ano corrente</p>
<?php 
if(is_array($disciplinas))
	foreach($disciplinas as $disciplina): ?>
	<div>
		<h2><?php echo $disciplina['codigo'].' - '.$disciplina['titulo'].' - '.$disciplina['ano'].'/'.$disciplina['periodo']; ?></h2>
		<p><?php echo $disciplina['subtitulo']?></p>
